...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(MetaCpan.instance().searchAuthors("Pedlar", 10, 0));
        System.out.println(MetaCpan.instance().searchDistribution("Sys-RunAlone-User", 10, 0));
        System.out.println(MetaCpan.instance().getRelease("Sys-RunAlone-User"));
        System.out.println(MetaCpan.instance().searchReleases("Sys-RunAlone-User", 10, 0));
    }
}